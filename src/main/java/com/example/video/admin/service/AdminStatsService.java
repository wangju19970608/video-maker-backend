...
public class AdminStatsService {
    ...
    public OverviewStatsDto overview() {
        ...
        dto.setTodaySalesAmount(defaultAmount(orderRepository.sumAmountByStatusAndCreatedAtBetween(OrderService.STATUS_PAID, startToday, endToday)));
        dto.setTodayPaidOrders(orderRepository.countByStatusAndCreatedAtBetween(OrderService.STATUS_PAID, startToday, endToday));
        dto.setTodayOrders(orderRepository.countByCreatedAtBetween(startToday, endToday));

        dto.setTotalSalesAmount(defaultAmount(orderRepository.sumAmountByStatus(OrderService.STATUS_PAID)));
        dto.setTotalPaidOrders(orderRepository.countByStatus(OrderService.STATUS_PAID));
        ...
        dto.setPendingOrders(orderRepository.countByStatus(OrderService.STATUS_PENDING));
    ...
    public List<DailySalesPointDto> dailySales(Integer days) {
        ...
        for (OrderRecord record : records) {
            ...
            if (OrderService.STATUS_PAID.equalsIgnoreCase(record.getStatus())) {
