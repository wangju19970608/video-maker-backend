...
import com.example.video.feign.TemplateFeignClient;
...
public class AdminOrderController {
    ...
    public org.springframework.http.ResponseEntity<org.springframework.core.io.Resource> downloadTemplateDocx(@PathVariable Long orderId) throws Exception {
        ...
        byte[] docxData = templateFeignClient.downloadTemplateDocx(order.getTemplate().getId());
        org.springframework.core.io.Resource resource = new org.springframework.core.io.ByteArrayResource(docxData);
    ...
    public ApiResponse<Object> generateCustom(@PathVariable Long orderId,
        ...
        Object task = videoTaskFeignClient.createFromCustomDocx(orderId, file);
