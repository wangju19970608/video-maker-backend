...
public class OrderService {
    ...
    public OrderView createOrder(CreateOrderRequest request, Long userId) {
        VideoTemplate template = templateRepository.findByIdAndEnabledTrue(request.getTemplateId())
    ...
    public TemplateView jumpTemplate(Long orderId, Long userId) {
        ...
        return templateFeignClient.getTemplate(record.getTemplate().getId());
    }
    ...
    public OrderView toView(OrderRecord record) {
        ...
        if (record.getTemplate() != null) {
            view.setTemplate(templateFeignClient.getTemplate(record.getTemplate().getId()));
        }
        return view;
    }
