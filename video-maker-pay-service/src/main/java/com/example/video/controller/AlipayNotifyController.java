...
import com.example.video.feign.OrderFeignClient;
...
public class AlipayNotifyController {
    ...
    public AlipayNotifyController(PaymentService paymentService, OrderFeignClient orderFeignClient) {
    ...
    public String notify(HttpServletRequest request) {
        try {
            ...
            if ("TRADE_SUCCESS".equals(tradeStatus) || "TRADE_FINISHED".equals(tradeStatus)) {
                ...
                orderFeignClient.payOrderByOrderNo(outTradeNo);
